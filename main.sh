...
function Paradoteo1(){
	...
	convert $Imagename1 -resize 160x160 $Basedir/site/images/$File1-thumb
	convert $Imagename2 -resize 160x160 $Basedir/site/images/$File2-thumb
	cp $Imagename1 $Basedir/site/images/$File1
	cp $Imagename2 $Basedir/site/images/$File2
